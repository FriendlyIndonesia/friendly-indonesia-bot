...
bot.on("callback_query", async (query) => {
  ...
  if (data.startsWith("pX.")) {
    ...
    const digiKatMap = { pulsa:"pulsa", data:"data", pln:"pln", game_ml:"game_ml", game_ff:"game_ff", ewallet:"ewallet", tv:"tv", gas:"gas" };
    ...
    const saldo = await getSaldo(id);
    const svcNames = { pulsa:"Pulsa", data:"Paket Data", pln:"Listrik PLN", game:"Top-up Game", game_ml:"Mobile Legends", game_ff:"Free Fire", ewallet:"E-Wallet", tv:"TV Kabel", gas:"Gas Pertamina" };
